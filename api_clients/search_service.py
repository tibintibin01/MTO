        ...
        return [
            {
                ...
                "subtitle": "Add a new land or building assessment",
                "type": "action",
                "command": "nav:new_property",
            },
            {
                "title": "📊 Generate Monthly Report",
                "subtitle": "View collection summary for this month",
                "type": "action",
                "command": "nav:reports",
            },
            {
                "title": "🛡️ Trigger Hybrid Backup",
                "subtitle": "Manual data protection snapshot",
                "type": "action",
                "command": "action:backup",
            },
            {
                "title": "👥 Manage User Access",
                "subtitle": "Add or edit system operators",
                "type": "action",
                "command": "nav:users",
            },
        ]

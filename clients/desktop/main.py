...
try:
    ...
    messagebox.showerror(
        "Municipal Treasury System | Configuration Error",
        f"The desktop connection configuration is invalid.\n\n{exc}",
    )
    root.destroy()
...
def handle_global_exception(exc_type, exc_value, exc_traceback):
    ...
    try:
        ...
        messagebox.showerror(
            tr("common.system_error"), "A critical system error occurred."
        )
...
class LoginApp(ctk.CTk):
    def __init__(self) -> None:
        ...
        self.title(
            f"Treasury Management System | {tr('common.error') if not auth else 'Secure Access'}"
        )
        ...
        self.brand_frame = ctk.CTkFrame(
            self, corner_radius=0, fg_color="#000000", border_width=0
        )
        ...
        try:
            ...
            self.logo_label.place(
                relx=0.5, rely=0.5, relwidth=1.1, relheight=1.1, anchor="center"
            )
        ...
        self.ue = ctk.CTkEntry(
            ...
            width=320,
            height=50,
            placeholder_text=tr("login.username"),
            font=ModernTheme.BODY,
        )
        self.ue.pack(pady=5)
        ...
        self.pe = ctk.CTkEntry(
            ...
            width=320,
            height=50,
            placeholder_text=tr("login.password"),
            show="*",
            font=ModernTheme.BODY,
        )
        self.pe.pack(pady=5)

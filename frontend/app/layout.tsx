...
export const metadata: Metadata = {
  ...
  description: "Official property tax portal of the Municipal Treasury Office of Dipaculao, Aurora. View your property assessment, payment history, and delinquency status.",
            ...
            <footer className="bg-[#0f2a5e] text-white mt-auto">
              <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-300 leading-relaxed">
                    Data collected is governed by the <strong className="text-white">Data Privacy Act of 2012 (RA 10173)</strong> and the <strong className="text-white">Local Government Code (RA 7160)</strong>.
                  </p>
